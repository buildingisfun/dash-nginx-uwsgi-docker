...
dash_app = dash.Dash(__name__, server = app, url_base_pathname = '/', meta_tags=[{"name": "viewport", "content": "width=device-width"}])
    ...
    html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.H5("TechVentureBuilder", style={"margin-top": "0px", 'color': 'white'}),
            ])
